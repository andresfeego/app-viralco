...
export function ResourceFilters({ theme, tab, onTabChange, search, onSearchChange, type, onTypeChange, poolLabel = t('resource_001'), horizontalTypes = false, showTabs = true }) {
  const typeOptions = [
